...
## Abstract
Employee attrition is a critical challenge for modern organizations, costing billions annually in lost productivity and hiring expenses. Traditional predictive models rely exclusively on internal HR metrics. This project introduces a hybrid framework that combines IBM HR Analytics data with LinkedIn job market signals to predict employee attrition more accurately.
